...
int32_t while_post_tested_loop(uint32_t flag);
...
int64_t _start(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
    // 0x1080
    int64_t v1; // 0x1080
    __libc_start_main(0x12b9, (int32_t)a6, (char **)&v1, NULL, NULL, (void (*)())a3);
    __asm_hlt();
    // UNREACHABLE
}
...
// From module:   /home/users/dragoss/Documents/licenta/Reverse-Engineering-Tool/testing_files/source/loops.c
// Address range: 0x1227 - 0x1272
// Line range:    37 - 49
int32_t while_pre_tested_loop(int32_t flag_2) {
    int32_t result = 0; // 0x126b
    if (flag_2 < 0) {
        // 0x126d
        return 0;
    }
...
// From module:   /home/users/dragoss/Documents/licenta/Reverse-Engineering-Tool/testing_files/source/loops.c
// Address range: 0x1272 - 0x12b9
// Line range:    51 - 63
int32_t while_post_tested_loop(uint32_t flag) {
    int32_t result = 0; // 0x1284
    result += 7;
    while (flag < 16) {
        // 0x128b
        result += 7;
