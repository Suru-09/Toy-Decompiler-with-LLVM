...
dec_label_pc_1060:
  ...
  %i3 = call i32 @__libc_start_main(i64 4508, i32 %i, i8** nonnull %i1, void ()* null, void ()* null, void ()* %i2), !insn.addr !8
...
dec_label_pc_1149:
  ...
  %i = icmp sgt i32 %n, 4, !insn.addr !24
  br i1 %i, label %dec_label_pc_116e, label %dec_label_pc_115a, !insn.addr !24

dec_label_pc_115a:                                ; preds = %dec_label_pc_1149
  %i1 = icmp eq i32 %n, 0, !insn.addr !25
  %i2 = icmp slt i32 %n, 0, !insn.addr !25
  %i3 = icmp eq i1 %i2, false, !insn.addr !26
  %i4 = icmp eq i1 %i1, false, !insn.addr !26
  %i5 = icmp eq i1 %i3, %i4, !insn.addr !26
  %. = select i1 %i5, i32 3, i32 2
  store i32 %., i32* %rax.0.reg2mem, align 4, !insn.addr !27
  br label %dec_label_pc_119a, !insn.addr !27

dec_label_pc_116e:                                ; preds = %dec_label_pc_1149
  %i6 = icmp eq i32 %n, 5, !insn.addr !28
  store i32 6, i32* %rax.0.reg2mem, align 4, !insn.addr !28
  br i1 %i6, label %dec_label_pc_119a, label %dec_label_pc_1174, !insn.addr !28

dec_label_pc_1174:                                ; preds = %dec_label_pc_116e
  %i7 = icmp slt i32 %n, 16, !insn.addr !29
  store i32 4, i32* %rax.0.reg2mem, align 4, !insn.addr !29
  br i1 %i7, label %dec_label_pc_1181, label %dec_label_pc_119a, !insn.addr !29

dec_label_pc_1181:                                ; preds = %dec_label_pc_1174
  %i8 = icmp slt i32 %n, 11, !insn.addr !30
  %.1 = select i1 %i8, i32 6, i32 5
  store i32 %.1, i32* %rax.0.reg2mem, align 4, !insn.addr !31
...
dec_label_pc_119c:
  %i = call i32 @two_way(i32 15), !insn.addr !33
  %i1 = zext i32 %i to i64, !insn.addr !34
  %i2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @global_var_2004, i64 0, i64 0), i64 %i1), !insn.addr !35
