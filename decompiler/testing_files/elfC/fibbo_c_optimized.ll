; ModuleID = '../testing_files/elfC/fibbo_c.ll'
...
dec_label_pc_1060:
  ...
  %i2 = call i32 @__libc_start_main(i64 4490, i32 %i, i8** nonnull %stack_var_8, void ()* null, void ()* null, void ()* %i1), !insn.addr !7
...
dec_label_pc_1149:
  %i = icmp slt i32 %n, 2, !insn.addr !21
  br i1 %i, label %dec_label_pc_1184, label %dec_label_pc_115f, !insn.addr !21

dec_label_pc_115f:                                ; preds = %dec_label_pc_1149
  %i1 = add i32 %n, -1, !insn.addr !22
  %i2 = call i32 @fibo(i32 %i1), !insn.addr !23
  %i3 = add i32 %n, -2, !insn.addr !24
  %i4 = call i32 @fibo(i32 %i3), !insn.addr !25
  %i5 = add i32 %i4, %i2, !insn.addr !26
  br label %dec_label_pc_1184, !insn.addr !27

dec_label_pc_1184:                                ; preds = %dec_label_pc_1149, %dec_label_pc_115f
  %storemerge.reg2mem.0 = phi i32 [ 1, %dec_label_pc_1149 ], [ %i5, %dec_label_pc_115f ]
  ret i32 %storemerge.reg2mem.0, !insn.addr !28
}

define i32 @main() local_unnamed_addr {
dec_label_pc_118a:
  %i = call i32 @fibo(i32 14), !insn.addr !29
  %i1 = zext i32 %i to i64, !insn.addr !30
  %i2 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([29 x i8], [29 x i8]* @global_var_2004, i64 0, i64 0), i64 15, i64 %i1), !insn.addr !31
