...
dec_label_pc_1060:
  ...
  %i2 = call i32 @__libc_start_main(i64 4522, i32 %i, i8** nonnull %stack_var_8, void ()* null, void ()* null, void ()* %i1), !insn.addr !7
...
dec_label_pc_1149:
  %i = icmp sgt i32 %n, 0, !insn.addr !21
  br i1 %i, label %dec_label_pc_1188.preheader.lr.ph, label %dec_label_pc_11a5, !insn.addr !21

dec_label_pc_1188.preheader.lr.ph:                ; preds = %dec_label_pc_1149
  %i1 = ashr i32 %n, 1, !insn.addr !22
  %i2 = zext i32 %i1 to i64, !insn.addr !22
  %i3 = icmp eq i32 %n, 1
...
dec_label_pc_116d:                                ; preds = %dec_label_pc_116d.lr.ph, %dec_label_pc_116d
  ...
  %stack_var_-20.0 = add i32 %i5, %stack_var_-20.12.reg2mem.0
  %i6 = add i32 %storemerge13.reg2mem.0, 1, !insn.addr !23
  %i7 = sext i32 %i6 to i64, !insn.addr !24
  %i8 = icmp slt i64 %i7, %i2, !insn.addr !24
  br i1 %i8, label %dec_label_pc_116d, label %dec_label_pc_1199.loopexit, !insn.addr !24
...
dec_label_pc_1199:                                ; preds = %dec_label_pc_1199.loopexit, %dec_label_pc_1188.preheader
  %stack_var_-20.1.lcssa.reg2mem.0 = phi i32 [ %stack_var_-20.25.reg2mem.0, %dec_label_pc_1188.preheader ], [ %stack_var_-20.0, %dec_label_pc_1199.loopexit ]
  %i9 = add nuw nsw i32 %storemerge6.reg2mem.0, 1, !insn.addr !25
  %exitcond = icmp eq i32 %i9, %n
  br i1 %exitcond, label %dec_label_pc_11a5.loopexit, label %dec_label_pc_1188.preheader, !insn.addr !21
...
dec_label_pc_116d.lr.ph:                          ; preds = %dec_label_pc_1188.preheader
  %i10 = icmp ult i32 %storemerge6.reg2mem.0, 3, !insn.addr !26
...
dec_label_pc_11a5:                                ; preds = %dec_label_pc_11a5.loopexit, %dec_label_pc_1149
  %stack_var_-20.2.lcssa.reg2mem.0 = phi i32 [ %stack_var_-20.1.lcssa.reg2mem.0, %dec_label_pc_11a5.loopexit ], [ 0, %dec_label_pc_1149 ]
  ret i32 %stack_var_-20.2.lcssa.reg2mem.0, !insn.addr !27
}

define i32 @main() local_unnamed_addr {
dec_label_pc_11aa:
  %i = call i32 @calc_sum(i32 10), !insn.addr !28
  %i1 = zext i32 %i to i64, !insn.addr !29
  %i2 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([20 x i8], [20 x i8]* @global_var_2004, i64 0, i64 0), i64 %i1), !insn.addr !30
